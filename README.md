...
1. 항공사관리자는 등록된 항공편 일정을 취소할 수 있다.
1. 고객이 항공편을 선택하여 결재까지 완료시 항공편 예약이 생성된다.
1. 예약 생성시 마일리지가 적립된다.
1. 고객이 예약한 항공편을 취소할 수 있다.
1. 예약 취소시 예약결재시의 마일리지 적립이 취소된다.
1. 항공편 예약상태가 변경될 때마다, 고객에게 알림을 보낸다.
1. 고객은 적립된 마일리지를 조회할 수 있다.
